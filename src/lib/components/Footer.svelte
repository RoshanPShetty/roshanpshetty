	...
	<div class="md:px-12 lg:px-28">
		<div class="container m-auto space-y-6 text-gray-300">
			<div class="m-auto flex w-max items-center justify-center space-x-4">
				...
				<a href="mailto:rshetty@umass.edu" aria-label="send mail">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="currentColor"
						class="m-auto w-5"
				...
				<a
					href="https://github.com/RoshanPShetty"
					title="github"
					target="blank"
					aria-label="github"
				>
				...
				<a
					href="https://www.linkedin.com/in/roshanshettyumass/"
					title="linkedin"
					target="blank"
					aria-label="linkedin"
				>
